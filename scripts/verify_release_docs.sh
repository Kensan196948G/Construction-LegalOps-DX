...
contains "docs/RELEASE_EVIDENCE_MATRIX.md" "Passed 37 / Failed 0 / Warnings 0" && pass "Evidence matrix records current Cloudflare preflight count" || fail "Evidence matrix missing current Cloudflare preflight count"
contains "docs/PRODUCTION_APPROVAL_PACKET.md" "Passed 37 / Failed 0 / Warnings 0" && pass "Approval packet records current Cloudflare preflight count" || fail "Approval packet missing current Cloudflare preflight count"
